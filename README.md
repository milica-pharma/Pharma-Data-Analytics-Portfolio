...
* **Blend Uniformity:** Identified a strong correlation ($R^2 = 0.88$) between Blend RSD and Capsule Content Uniformity, validating its use as a primary process control.
* **Dissolution Impact:** Found a statistically significant but practically low correlation ($R^2 = 0.11$) between lactose moisture and dissolution, suggesting the capsule shell remains the rate-limiting factor.
